...
class RandomAgent(BaseAgent):
    ...
    def _move_toward_food(self, obs: AntObservation) -> int:
        ...
        if not food_positions:
            ...
            return random.choice(list(Action.DIRECTIONS.keys()))
...
class SmartRandomAgent(RandomAgent):
    ...
    def get_actions(
        ...
        """Get actions with slightly smarter logic."""
        actions = {}
