"""Simple Q-learning agent - updated for independent ant control."""
...
class SimpleQLearningAgent(BaseAgent):
    ...
    Each ant acts independently but shares a common Q-table.
    The agent learns which actions are good in which situations.
    """
    ...
    def __init__(
        ...
        # Shared across all ants
        self.q_table = defaultdict(lambda: defaultdict(float))

        # Experience tracking per ant (persists across get_action calls)
        self.last_states = {}  # ant_id -> state
        self.last_actions = {}  # ant_id -> action
    ...
    def get_action(
        ...
        """
        Get action for a single ant using Q-learning.
    ...
    def update_q_values(
        ...
        Args:
            rewards: Dictionary of ant_id -> reward
...
class TabularAgent(BaseAgent):
    ...
    Uses a hand-crafted policy that can be learned/updated.
    """
    ...
    def get_action(
        ...
        """Get action based on simple policy."""
        obs = observation
